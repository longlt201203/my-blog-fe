import { Button, Container, Dropdown, Form, Nav, Navbar, Stack } from "react-bootstrap";
import { LinkContainer } from 'react-router-bootstrap';

export default function Header() {
    return (
        <Navbar bg='light' data-bs-theme='light' className="p-3 position-sticky top-0 z-1">
            <Container>
                <LinkContainer to="/">
                    <Navbar.Brand>Lethanhlong</Navbar.Brand>
                </LinkContainer>
                ...
                <Form>
                    <Stack direction="horizontal" gap={1}>
                        ...
                        <Dropdown drop="start">
                            ...
                            <Dropdown.Menu>
                                <Dropdown.Item active>VN</Dropdown.Item>
