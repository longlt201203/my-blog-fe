import { Button, Table, ButtonGroup, Spinner } from "react-bootstrap";
...
export default function AdminTagsPage() {
    ...
    const { status, data, error } = useQuery<GetManyDto<Tag>, Error>("getTags", TagsQuery.getTags);
    ...
    return (
        <AdminLayout>
            ...
            <Table variant="info" hover>
                ...
                <tbody>
                    {status == "loading" ? (<Spinner animation="border" />) : status == "error" ? (<>{toast("Get Tags Error")}</>) : (
